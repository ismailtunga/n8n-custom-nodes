...
import {
        ...
        [
	{
		...
		"options": [
			{
				"name": "new incident edit data",
				"value": "newIncidentEditData"
			},
			{
				"name": "new incident",
				"value": "newIncident"
			...
			{
				"name": "edit incident data",
				"value": "editIncidentData"
			},
			{
	...
	{
		"displayName": "root loss incident id",
		"name": "RootLossIncidentID",
		"type": "string",
		"default": "",
		"displayOptions": {
			"show": {
